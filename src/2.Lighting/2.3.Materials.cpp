...
int main()
{
    ...
    string vertexPath = dirPath + "2.3.basic_lighting.vs";
    string fragmentPath = dirPath + "2.3.basic_lighting.fs";
    Shader lightingShader(vertexPath.c_str(), fragmentPath.c_str());
    string vertex2Path = dirPath + "2.1.light_cube.vs";
    string fragment2Path = dirPath + "2.1.light_cube.fs";
    Shader lightCubeShader(vertex2Path.c_str(), fragment2Path.c_str());
