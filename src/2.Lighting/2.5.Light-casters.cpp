...
int main()
{
    ...
    /// Shader Settings
    string dirPath = "./Desktop/Refer/OpenGL/include/shaders/lighting/";
    string vertexPath = dirPath + "2.5.light_casters.vs";
    string fragmentPath = dirPath + "2.5.light_casters.fs";
    ...
    unsigned int diffuseMap = loadTexture((dirImgPath + "container2.png").c_str());
    unsigned int specularMap = loadTexture((dirImgPath + "container2_specular.png").c_str());
    lightingShader.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            lightingShader.setMat4("model", trans * model);
